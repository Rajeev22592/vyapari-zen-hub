...
const MarketsDownPage = () => {
  ...
  const { data } = useQuery({
    queryKey: ["markets-down", filters, dateParam, currentPage, perPage],
    queryFn: () =>
      fetchMarketsDown({
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-4 mb-2">
              ...
              <h1 className="text-2xl font-bold">Markets Down</h1>
            </div>
            <p className="text-muted-foreground">Average modal price fell vs yesterday • {total}</p>
          </div>
        </div>
              ...
              <Card key={idx} className="bg-background border-border/70 shadow-soft hover:shadow-elevated transition-all">
                <CardHeader className="pb-2">
                  <CardTitle className="text-lg flex items-center justify-between">
                    ...
                    <Badge className="bg-destructive">{change}</Badge>
                  </CardTitle>
                </CardHeader>
                <CardContent className="text-sm text-muted-foreground flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="h-10 w-10 rounded-md bg-destructive/10 text-destructive flex items-center justify-center text-lg">
                        {commodityImage}
                      </div>
...
export default MarketsDownPage;